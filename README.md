...
## Environments
- Preview: https://main--site-25--s24onboading.hlx.page/
- Live: https://main--site-25--s24onboading.hlx.live/
- Custom Domain: https://site-25.playground.name (Available during the lab)
...
WKND_URL=https://main--site-25--s24onboading.hlx.live ITERATIONS=1000 npm run generate-traffic
```
